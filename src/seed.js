...
export const teams = [
  ...
  { id: 't4', name: 'Harbor Hustlers', color: '#22d3ee', leagueId: 'l1', captainPlayerId: 'p7', roster: [{ playerId: 'p7', order: 1 }, { playerId: 'p8', order: 2 }] },
  { id: 't5', name: 'Fells Point Putters', color: '#a78bfa', leagueId: 'l1', captainPlayerId: 'p9', roster: [{ playerId: 'p9', order: 1 }, { playerId: 'p10', order: 2 }] },
  { id: 't6', name: 'Federal Hill Flames', color: '#f97316', leagueId: 'l1', captainPlayerId: 'p11', roster: [{ playerId: 'p11', order: 1 }, { playerId: 'p12', order: 2 }] },
  { id: 't7', name: 'Canton Sinkers', color: '#22c55e', leagueId: 'l1', captainPlayerId: 'p13', roster: [{ playerId: 'p13', order: 1 }, { playerId: 'p14', order: 2 }] },
  { id: 't8', name: 'Hampden Hons', color: '#ec4899', leagueId: 'l1', captainPlayerId: 'p15', roster: [{ playerId: 'p15', order: 1 }, { playerId: 'p16', order: 2 }] },
  { id: 't9', name: 'Charm City Strokers', color: '#14b8a6', leagueId: 'l1', captainPlayerId: 'p17', roster: [{ playerId: 'p17', order: 1 }, { playerId: 'p18', order: 2 }] },
  ...
  { id: 't13', name: 'Dundalk Ringers', color: '#f59e0b', leagueId: 'l2', captainPlayerId: 'p25', roster: [{ playerId: 'p25', order: 1 }, { playerId: 'p26', order: 2 }] },
  { id: 't14', name: 'Locust Point Legends', color: '#8b5cf6', leagueId: 'l2', captainPlayerId: 'p27', roster: [{ playerId: 'p27', order: 1 }, { playerId: 'p28', order: 2 }] },
  { id: 't15', name: 'Mt. Vernon Vipers', color: '#06b6d4', leagueId: 'l2', captainPlayerId: 'p29', roster: [{ playerId: 'p29', order: 1 }, { playerId: 'p30', order: 2 }] },
  ...
  { id: 't17', name: 'Remington Rollers', color: '#10b981', leagueId: 'l2', captainPlayerId: 'p33', roster: [{ playerId: 'p33', order: 1 }, { playerId: 'p34', order: 2 }] },
  ...
  { id: 't23', name: 'Charles Village Champs', color: '#a855f7', leagueId: 'l3', captainPlayerId: 'p45', roster: [{ playerId: 'p45', order: 1 }, { playerId: 'p46', order: 2 }] },
